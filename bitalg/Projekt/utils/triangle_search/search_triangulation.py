...
from bitalg.Projekt.utils.triangle_search.jump_and_walk import jump_and_walk_triangle_search
from bitalg.Projekt.utils.triangle_search.directed_graph_dfs import dfs_trianglation
